...
shp <- 'D:/data/NaturalEarthData/ne_50m_admin_1_states_provinces/ne_50m_admin_1_states_provinces.shp'
usa <- sf::st_read(shp) %>%
  st_as_sf() %>%
...
save(bhu_bb, riv, usa, file = './data/helper_data_map.RData')
```
...
domap <-
  ...
  tm_layout(legend.position= c("left", "bottom"), 
            title= 'DO map on ...', title.position = c('left', 'top'),
            # main.title = 'DO map on 6/1', main.title.position = "left", 
...
for (ras in ras_ls) {
  ...
  domap <-
    ...
    tm_layout(bg.color = 'black', legend.height = 0.6, #legend.width = .3, #legend.text.size = 1.5, legend.title.size = 1.5, 
              legend.bg.color = 'black', legend.bg.alpha = 0.5, 
              ...
              legend.position= c("right", "bottom"), legend.just = 'bottom')
  # domap
  assign(map_nm, domap)
}
