...
# csv <- './data/results_RF/area_dz_over_time_geeRF.csv'
# csv <- './data/results_RF/area_dz_over_time_geeRF_10d.csv'
csv <- './data/results_RF/area_dz_over_time_geeRF_10d_R1.csv' ## 2022-05-12
...
for (i in 1:length(dat_ls)) {
  ...
  fname <- paste0('./data/', which_dat, 'mapDatFull_dz_area_overTime', postfix, '.csv'); print(fname)
...
```{r - FDA & LLR}
area_dz_fr <- readr::read_csv(paste0("./data/FRmapDatFull_dz_area_overTime", postfix, ".csv"))
area_dz_ll <- readr::read_csv(paste0("./data/LLmapDatFull_dz_area_overTime", postfix, ".csv"))
