...
**Intro**
  ...
  The data used to plot hypoxia maps are generated from GEE. See section `Package and Dirs` for details. 
...
## data path
dir.do.tif <- './data/data_from_gee/predict_do_maps_lag10d/'    ## 2021-11-24 (first submission)
dir.do.tif <- './data/data_from_gee/predict_do_maps_lag10d_R1'  ## 2022-05-10
...
## dz freq map (NOT use this one --> see ArcGIS version)
...
func_domap_1col(n_plots = 9, h = 3.2/2, postfix = "_R1.1")
```
